...
<div class="container p-5 text-center">
  <h5>Important COVID-19 notice</h5>
...
— Aaron Siskind</div>
  ...
  <br>
    <div class="card bg-dark text-white">
      <div class="card-body"><a href="shop.php"></a></div>
    <div
  ...
  <div class="container p-5 text-center">
    ...
    <br>
    <div class="card bg-dark text-white">
      <div class="card-body">Summer Shirts and Tops Collection!</div>
    <div
      class="p-5 text-center bg-image"
      style="background-image: url('https://merishop.pk/wp-content/uploads/2020/12/15651607982870606985.jpg'); height: 1000px;"
    >
  ...
  <br>
    <div class="card bg-dark text-white">
      <div class="card-body">Summer Maxi Dress Collection!</div>
    <div
      class="p-5 text-center bg-image"
      style="background-image: url('https://merishop.pk/wp-content/uploads/2021/03/1599546139ef87d45092460680add0c0f46690fedc.jpg'); height: 1000px;"
    >
    </div>
  ...
  <br>
    <div class="card bg-dark text-white">
      <div class="card-body">Summer Women Trouser Collection!</div>
    <div
      class="p-5 text-center bg-image"
      style="background-image: url('https://merishop.pk/wp-content/uploads/2020/12/Bow-Knot-Elastic-Waist-Pocket-Harem-Pants1.jpg'); height: 700px;"
    >
    </div>
